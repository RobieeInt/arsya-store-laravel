                ...
                <div class="col-lg-4">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email" v-model="email" @change="checkEmail()"
                        ...
                        <div class="form-group">
                            <label>Toko</label>
                            <p class="text-muted">Mau buka Toko Juga ga ?</p>
                        ...
                        <button type="submit" href="/index.html" class="btn btn-success btn-block mt-4"
                ...
                checkEmail: function() {
                    ...
                    .then(function (response) {
                        ...
                        if(response.data == 'Available') {
                            self.$toasted.show("Email Tersedia, Lanjutkan Langkah Berikutnya", {
                            position: "top-center",
                            className: "rounded",
                            duration: 3000,
                            });
                            ...
                            self.$toasted.error("Maaf, Emailnya udah Terdaftar ni..", {
                            position: "top-center",
                            className: "rounded",
                            duration: 3000,
                            });
